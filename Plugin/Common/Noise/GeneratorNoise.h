...
{
	public:
		GeneratorNoise(int seed = 1337) { SetSeed(seed); };
		~GeneratorNoise() { delete m_cellularNoiseLookup; }

		void SetSeed(int seed);
		int GetSeed(void) const { return m_seed; }
		void SetNoiseSettings(NoiseSettings m_noiseSettings);
		...
		void SetCellularNoiseLookup(GeneratorNoise* noise) { m_cellularNoiseLookup = noise; }
	...
	protected:
		...
		GeneratorNoise* m_cellularNoiseLookup = nullptr;
