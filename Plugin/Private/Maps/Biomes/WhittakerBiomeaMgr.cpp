...
const FName WhittakerBiomeaMgr::BIOME_IceTag = TEXT("MapData.Biome.Frozen.Ice");
const FName WhittakerBiomeaMgr::BIOME_MarshTag = TEXT("MapData.Biome.Water.Marsh");
const FName WhittakerBiomeaMgr::BIOME_LakeTag = TEXT("MapData.Biome.Water.Lake");
const FName WhittakerBiomeaMgr::BIOME_SnowTag = TEXT("MapData.Biome.Frozen.Snow");
const FName WhittakerBiomeaMgr::BIOME_TundraTag = TEXT("MapData.Biome.Frozen.Tundra");
const FName WhittakerBiomeaMgr::BIOME_BareTag = TEXT("MapData.Biome.Bare");
const FName WhittakerBiomeaMgr::BIOME_ScorchedTag = TEXT("MapData.Biome.Scorched");
const FName WhittakerBiomeaMgr::BIOME_TaigaTag = TEXT("MapData.Biome.Frozen.Taiga");
const FName WhittakerBiomeaMgr::BIOME_ShrublandTag = TEXT("MapData.Biome.Shrubland");
const FName WhittakerBiomeaMgr::BIOME_TemperateDesertTag = TEXT("MapData.Biome.TemperateDesert");
const FName WhittakerBiomeaMgr::BIOME_TemperateRainForestTag = TEXT("MapData.Biome.TemperateRainForest");
const FName WhittakerBiomeaMgr::BIOME_TemperateDeciduousForestTag = TEXT("MapData.Biome.TemperateDeciduousForest");
const FName WhittakerBiomeaMgr::BIOME_GrasslandTag = TEXT("MapData.Biome.Grassland");
const FName WhittakerBiomeaMgr::BIOME_TropicalRainForestTag = TEXT("MapData.Biome.TropicalRainForest");
const FName WhittakerBiomeaMgr::BIOME_TropicalSeasonalForestTag = TEXT("MapData.Biome.TropicalSeasonalForest");
const FName WhittakerBiomeaMgr::BIOME_SubtropicalDesertTag = TEXT("MapData.Biome.SubtropicalDesert");

WhittakerBiomeaMgr::WhittakerBiomeaMgr()
{
	Biomes.Empty();
...
EWhittakerBiome WhittakerBiomeaMgr::ConvertToWhittakerBiomeEnum(const FGameplayTag& BiomeName)
{
