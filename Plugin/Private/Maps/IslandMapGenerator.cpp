...
void AIslandMapGenerator::ResetMap()
{
	...
	if (IslandData.BiomeManager == NULL)
	{
		...
		BiomeManager = NewObject<BiomesMgr>(this,TEXT("Biome Manager"));
	}
	else
	{
		BiomeManager = NewObject<BiomesMgr>(this,IslandData.BiomeManager,TEXT("Biome Manager"));
	}

	if (IslandData.ElevationDistributor == NULL)
	{
		UE_LOG(LogWorldGen, Error, TEXT("Elevation Distributor was null!"));
		ElevationDistributor = NewObject<DistributorOfElevations>(this, TEXT("Elevation Distributor"));
	}
	else
	{
		ElevationDistributor = NewObject<DistributorOfElevations>(this, IslandData.ElevationDistributor, TEXT("Elevation Distributor"));
	}

	if (IslandData.MoistureDistributor == NULL)
	{
		UE_LOG(LogWorldGen, Error, TEXT("Moisture Distributor was null!"));
		MoistureDistributor = NewObject<DistributorOfMoistures>(this, TEXT("Moisture Distributor"));
	}
	else
	{
		MoistureDistributor = NewObject<DistributorOfMoistures>(this, IslandData.MoistureDistributor, TEXT("Moisture Distributor"));
	}
